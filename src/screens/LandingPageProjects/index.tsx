...
import ChannelsGraphic from "src/assets/channelsGraphic.png";
            ...
            <>
              ...
              >
                <label style={styles.mainText}>
                  The all-in-one platform for errors, logging, and debugging.
                </label>
                ...
                <div style={styles.exampleContainer}>
                  <img src={ChannelsGraphic} style={styles.exampleGraphic1} />
                </div>
              </div>
            </>
          ) : (
